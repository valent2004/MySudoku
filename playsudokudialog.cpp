                                                                ...
                                                                if(right >= 0)
                                                                {
                                                                    ...
                                                                    if(right >= 0)
                                                                    {
                                                                        ...
                                                                        if(right >= 0)
                                                                        {
                                                                            ...
                                                                            int uR1 = 0;
                                                                            right = massive(sudokuField.row1, notSameRow1, this_one, num, uR1);
                                                                            if(right >= 0)
                                                                            {
                                                                                notSameRow1.clear();
                                                                                massive(sudokuField.row1, notSameRow1, this_one, num, uR1);
                                                                                QVector<QString> notSameRow2;
                                                                                int uR2 = 0;
                                                                                right = massive(sudokuField.row2, notSameRow2, this_one, num, uR2);
                                                                                if(right >= 0)
                                                                                {
                                                                                    notSameRow2.clear();
                                                                                    massive(sudokuField.row2, notSameRow2, this_one, num, uR2);
                                                                                    QVector<QString> notSameRow3;
                                                                                    int uR3 = 0;
                                                                                    right = massive(sudokuField.row3, notSameRow3, this_one, num, uR3);
                                                                                    if(right >= 0)
                                                                                    {
                                                                                        notSameRow3.clear();
                                                                                        massive(sudokuField.row3, notSameRow3, this_one, num, uR3);
                                                                                        QVector<QString> notSameRow4;
                                                                                        int uR4 = 0;
                                                                                        right = massive(sudokuField.row4, notSameRow4, this_one, num, uR4);
                                                                                        if(right >= 0)
                                                                                        {
                                                                                            notSameRow4.clear();
                                                                                            massive(sudokuField.row4, notSameRow4, this_one, num, uR4);
                                                                                            QVector<QString> notSameRow5;
                                                                                            int uR5 = 0;
                                                                                            right = massive(sudokuField.row5, notSameRow5, this_one, num, uR5);
                                                                                            if(right >= 0)
                                                                                            {
                                                                                                notSameRow5.clear();
                                                                                                massive(sudokuField.row5, notSameRow5, this_one, num, uR5);
                                                                                                QVector<QString> notSameRow6;
                                                                                                int uR6 = 0;
                                                                                                right = massive(sudokuField.row6, notSameRow6, this_one, num, uR6);
                                                                                                if(right >= 0)
                                                                                                {
                                                                                                    notSameRow6.clear();
                                                                                                    massive(sudokuField.row6, notSameRow6, this_one, num, uR6);
                                                                                                    QVector<QString> notSameRow7;
                                                                                                    int uR7 = 0;
                                                                                                    right = massive(sudokuField.row7, notSameRow7, this_one, num, uR7);
                                                                                                    if(right >= 0)
                                                                                                    {
                                                                                                        notSameRow7.clear();
                                                                                                        massive(sudokuField.row7, notSameRow7, this_one, num, uR7);
                                                                                                        QVector<QString> notSameRow8;
                                                                                                        int uR8 = 0;
                                                                                                        right = massive(sudokuField.row8, notSameRow8, this_one, num, uR8);
                                                                                                        if(right >= 0)
                                                                                                        {
                                                                                                            notSameRow8.clear();
                                                                                                            massive(sudokuField.row8, notSameRow8, this_one, num, uR8);
                                                                                                            QVector<QString> notSameRow9;
                                                                                                            int uR9 = 0;
                                                                                                            right = massive(sudokuField.row9, notSameRow9, this_one, num, uR9);
                                                                                                            if(right >= 0)
                                                                                                            {
                                                                                                                notSameRow9.clear();
                                                                                                                massive(sudokuField.row9, notSameRow9, this_one, num, uR9);
